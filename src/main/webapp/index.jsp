...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://capartech.com/blog">
        <link rel="stylesheet" href="https://capartech.com/blog">
        <link rel="stylesheet" href="https://capartech.com/blog">
        <link rel="stylesheet" 
    ...
    <body>
        <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
            <a class="w3-bar-item w3-button w3-border-bottom w3-large" href="#"><img src="https://capartech.com/blog" style="width:80%;"></a>
